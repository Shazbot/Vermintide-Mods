...
mod.SETTING_NAMES = {
    ...
    HIT_MARKERS_FF_COLOR_GROUP = "HIT_MARKERS_FF_COLOR_GROUP",
    HIT_MARKERS_FF_RED = "HIT_MARKERS_FF_RED",
    HIT_MARKERS_FF_GREEN = "HIT_MARKERS_FF_GREEN",
    HIT_MARKERS_FF_BLUE = "HIT_MARKERS_FF_BLUE",
    HIT_MARKERS_HS_AND_CRIT_COLOR_GROUP = "HIT_MARKERS_HS_AND_CRIT_COLOR_GROUP",
    HIT_MARKERS_HS_AND_CRIT_RED = "HIT_MARKERS_HS_AND_CRIT_RED",
    HIT_MARKERS_HS_AND_CRIT_GREEN = "HIT_MARKERS_HS_AND_CRIT_GREEN",
    HIT_MARKERS_HS_AND_CRIT_BLUE = "HIT_MARKERS_HS_AND_CRIT_BLUE",
    HIT_MARKERS_ARMORED_COLOR_GROUP = "HIT_MARKERS_ARMORED_COLOR_GROUP",
    HIT_MARKERS_ARMORED_RED = "HIT_MARKERS_ARMORED_RED",
...
mod_data.options_widgets = {
   {
	...
	},
	{
		...
		["sub_widgets"] = {
			...
			{
				["setting_name"] = mod.SETTING_NAMES.HIT_MARKERS_FF_COLOR_GROUP,
				["widget_type"] = "checkbox",
				["text"] = mod:localize("HIT_MARKERS_FF_COLOR_GROUP"),
				["tooltip"] = mod:localize("HIT_MARKERS_FF_COLOR_GROUP_T"),
				["default_value"] = false,
				["sub_widgets"] = {
				    {
						["setting_name"] = mod.SETTING_NAMES.HIT_MARKERS_FF_RED,
						["widget_type"] = "numeric",
						["text"] = mod:localize("red"),
						["tooltip"] = mod:localize("custom_red_tooltip"),
						["range"] = {0, 255},
					...
					{
						["setting_name"] = mod.SETTING_NAMES.HIT_MARKERS_FF_GREEN,
						["widget_type"] = "numeric",
						["text"] = mod:localize("green"),
						["tooltip"] = mod:localize("custom_green_tooltip"),
						["range"] = {0, 255},
					...
					{
						["setting_name"] = mod.SETTING_NAMES.HIT_MARKERS_FF_BLUE,
						["widget_type"] = "numeric",
						["text"] = mod:localize("blue"),
						["tooltip"] = mod:localize("custom_blue_tooltip"),
						["range"] = {0, 255},
			...
			{
				["setting_name"] = mod.SETTING_NAMES.HIT_MARKERS_HS_AND_CRIT_COLOR_GROUP,
				["widget_type"] = "checkbox",
				["text"] = mod:localize("HIT_MARKERS_HS_AND_CRIT_COLOR_GROUP"),
				["tooltip"] = mod:localize("HIT_MARKERS_HS_AND_CRIT_COLOR_GROUP_T"),
				["default_value"] = false,
				["sub_widgets"] = {
				    {
						["setting_name"] = mod.SETTING_NAMES.HIT_MARKERS_HS_AND_CRIT_RED,
						["widget_type"] = "numeric",
						["text"] = mod:localize("red"),
						["tooltip"] = mod:localize("custom_red_tooltip"),
						["range"] = {0, 255},
					...
					{
						["setting_name"] = mod.SETTING_NAMES.HIT_MARKERS_HS_AND_CRIT_GREEN,
						["widget_type"] = "numeric",
						["text"] = mod:localize("green"),
						["tooltip"] = mod:localize("custom_green_tooltip"),
						["range"] = {0, 255},
					...
					{
						["setting_name"] = mod.SETTING_NAMES.HIT_MARKERS_HS_AND_CRIT_BLUE,
						["widget_type"] = "numeric",
						["text"] = mod:localize("blue"),
						["tooltip"] = mod:localize("custom_blue_tooltip"),
						["range"] = {0, 255},
			...
			{
				["setting_name"] = mod.SETTING_NAMES.HIT_MARKERS_ARMORED_COLOR_GROUP,
				["widget_type"] = "checkbox",
				["text"] = mod:localize("HIT_MARKERS_ARMORED_COLOR_GROUP"),
				["tooltip"] = mod:localize("HIT_MARKERS_ARMORED_COLOR_GROUP_T"),
				["default_value"] = false,
				["sub_widgets"] = {
				    {
						["setting_name"] = mod.SETTING_NAMES.HIT_MARKERS_ARMORED_RED,
						["widget_type"] = "numeric",
						["text"] = mod:localize("red"),
						["tooltip"] = mod:localize("custom_red_tooltip"),
						["range"] = {0, 255},
					...
					{
						["setting_name"] = mod.SETTING_NAMES.HIT_MARKERS_ARMORED_GREEN,
						["widget_type"] = "numeric",
						["text"] = mod:localize("green"),
						["tooltip"] = mod:localize("custom_green_tooltip"),
						["range"] = {0, 255},
					...
					{
						["setting_name"] = mod.SETTING_NAMES.HIT_MARKERS_ARMORED_BLUE,
						["widget_type"] = "numeric",
						["text"] = mod:localize("blue"),
						["tooltip"] = mod:localize("custom_blue_tooltip"),
						["range"] = {0, 255},
			...
			{
				["setting_name"] = mod.SETTING_NAMES.IGNORE_FF_TRESHOLD,
				["widget_type"] = "numeric",
