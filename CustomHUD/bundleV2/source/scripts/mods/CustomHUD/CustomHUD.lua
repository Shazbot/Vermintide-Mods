...
mod:hook(UnitFrameUI, "_update_voice_animation", function(func, ...)
	return false

	-- local ret_val = false

	-- local success, ret_val = pcall(func, ...)
...
mod:hook(UnitFrameUI, "_reset_voice_animation", function(func, self)
end)
