...
mod.localizations:update({
	...
	dcui_display_cooldown = {
		en = "Display cooldown",
	},
	dcui_display_cooldown_description = {
		en = "Display cooldown",
	},
	dcui_always_on_description = {
		en = "When disabled the UI will disappear when your dodge count is full",
	},
	dcui_offset_x = {
		en = "Offset X",
	},
	dcui_offset_x_description = {
		en = "Offset from the center of the screen in the X axis",
	},
	dcui_offset_y = {
		en = "Offset Y",
	},
	dcui_offset_y_description = {
		en = "Offset from the center of the screen in the Y axis",
	},
	dcui_font_size = {
		en = "Dodge count font size"
	},
	dcui_font_size_description = {
		en = "Dodge count font size"
	},
	dcui_cd_font_size = {
		en = "Cooldown font size"
	},
	dcui_cd_font_size_description = {
		en = "Cooldown font size"
	},
	dodge_count = {
		en = "Dodge Count"
