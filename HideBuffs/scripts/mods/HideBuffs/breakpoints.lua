...
mod.item_type_to_breakpoints = {
	...
	wh_repeating_crossbow = "FOR WH(NOT ELF): 2 skaven/armoured properties to let you (as BH with Crippling Strike) singleshot 2-tap bodyshot gunners/warpfires & hooks with your passive crit up, or 1-shot headshot gunner/warpfires with crit single shot.",
	...
	ww_dual_swords = "",
	ww_hagbane = "",
	ww_longbow = "FOR SOLDIER(NOT ELF): 20% Skaven/Armored on the weapon and 10% Skaven/Armored and 10% Chaos/Infantry on the charm to oneshot bodyshot Stormvermin, Warpfires & Ratlings with a fully charged arrow and to 2 shot bodyshot Leeches/Blightstormers with partially charged arrows.",
	ww_shortbow = "",
	ww_sword_and_dagger = "",
}
