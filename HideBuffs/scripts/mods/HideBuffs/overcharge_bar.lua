...
mod:hook(OverchargeBarUI, "_update_overcharge", function(func, self, player, ...)
	local has_overcharge = func(self, player, ...)
	...
	if ammo_count and clip_size and clip_size > 0 then
        ...
        self:set_charge_bar_fraction(player, ammo_fraction, min_threshold_fraction, max_threshold_fraction)
