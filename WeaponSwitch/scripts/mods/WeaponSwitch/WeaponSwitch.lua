...
function (func, t, unit, input_extension, inventory_extension, health_extension)
	...
	local success = pcall(function()
		...
		elseif item_template.next_action then
			...
			if not new_action or not new_sub_action or not item_template.actions[new_action] or not item_template.actions[new_action][new_sub_action] then
	...
	if not success then
		return func(t, unit, input_extension, inventory_extension, health_extension)
	end
end)
